...
$(function(){$(".hamburger").on("click",function(t){$(this).toggleClass("is-active")}),$(".menu--link").click(function(t){t.preventDefault();var e=$(this).attr("href"),n=$(e).offset().top;$("body,html").animate({scrollTop:n},750)}),$(window).scroll(function(){$(window).scrollTop()>0?$(".top-lane").css({"margin-top":"0"}):$(".top-lane").css({"margin-top":"40px"}),$(window).width()<480&&$(".top-lane").css({"margin-top":"0"})});new Typed(".ques",{strings:["- Can you build website of my dreams?"],typeSpeed:60}),new Typed(".ans",{strings:["- Yup, we can do that."],typeSpeed:60,startDelay:3500});setTimeout(function(){$(".header-button").fadeIn("5000")},5e3)});